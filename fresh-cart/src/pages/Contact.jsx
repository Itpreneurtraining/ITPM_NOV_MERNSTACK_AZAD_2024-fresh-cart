...
export default function ContactUs() {
  ...
  return (
    ...
    <div className="tw:main tw:text-[#000] tw:grid  tw:grid-col tw:justify-items-center tw:items-stretch tw:gap-y-[1rem] tw:!py-[2rem]">
      <img className="tw:opacity-60" src="photo.jpg" alt="photo is not found" />
      <div className="tw:pho tw:py-4"></div>

      <div className="tw:gap-x-16 tw:py-16 tw:grid tw:grid-col tw:justify-items-center tw:items-center">
        <div className="tw:gap-x-16 sm:tw:flex">
          <div className="tw:border-2  tw:my-4 sm:tw:border-none">
      ...
      <div className="tw:map tw:sm-w-1 tw:w-[100%]">
        <iframe
      ...
      <div className="tw:isolate tw:bg-white tw:px-6 tw:py-24 sm:tw:py-32 lg:tw:px-8">
        ...
        <div className="tw:mx-auto tw:max-w-2xl tw:text-center">
          <h3 className="tw:text-4xl tw:font-semibold tw:tracking-tight tw:text-balance tw:text-gray-900 sm:tw:text-5xl">Contact sales</h3>
